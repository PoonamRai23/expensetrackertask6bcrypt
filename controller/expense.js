...
const database=require('../utill/user')
...
exports.createExpenseController=async(req,res)=>{
    try{
        ...
        if(itemname===undefined||itemname.length===0 ||description===undefined||description.length=== 0||category===undefined||category.length===0){
            return res.status(400).json({err:'bad parameters something is missing'})
        }
        
            console.log('this is postdata.............>>>>>>',itemname,description)
